...
/-- If `f` is a nonarchimedean additive group seminorm on `α`, then for every `n : ℕ` and `a : α`,
  we have `f (n • a) ≤ (f a)`. -/
lemma is_nonarchimedean_nsmul {F α : Type*} [add_comm_group α] [add_group_seminorm_class F α ℝ] 
...
/-- If `f` is a nonarchimedean additive group seminorm on `α`, then for every `n : ℕ` and `a : α`,
  we have `f (n * a) ≤ (f a)`. -/
lemma is_nonarchimedean_nmul {F α : Type*} [ring α] [add_group_seminorm_class F α ℝ] {f : F}
...
lemma is_nonarchimedean_add_eq_max_of_ne {F α : Type*} [ring α] [add_group_seminorm_class F α ℝ]
...
/-- Given a nonarchimedean additive group seminorm `f` on `α`, a function `g : β → α` and a finset
  ...
  `f (t.sum g) ≤ f (g b)` . -/
lemma is_nonarchimedean_finset_image_add {F α : Type*} [ring α] [add_group_seminorm_class F α ℝ]
...
lemma is_nonarchimedean_multiset_image_add {F α : Type*} [ring α] [add_group_seminorm_class F α ℝ]
...
lemma is_nonarchimedean_finset_range_add_le {F α : Type*} [ring α] [add_group_seminorm_class F α ℝ]
...
lemma is_nonarchimedean_add_pow {F α : Type*} [comm_ring α] [ring_seminorm_class F α ℝ] {f : F}
...
lemma map_pow_le_pow {F α : Type*} [ring α] [ring_seminorm_class F α ℝ] (f : F) (a : α) :
  ∀ {n : ℕ}, n ≠ 0 → f (a ^ n) ≤ f a ^ n
| 0 h       := absurd rfl h
...
lemma map_pow_le_pow' {F α : Type*} [ring α] [ring_seminorm_class F α ℝ] {f : F} (hf1 : f 1 ≤ 1) 
  (a : α) : ∀ (n : ℕ), f (a ^ n) ≤ f a ^ n
...
class algebra_norm_class (F : Type*) (R : out_param $ Type*) [semi_normed_comm_ring R]
  ...
  extends seminorm_class F R S, ring_norm_class F S ℝ 
...
class mul_algebra_norm_class (F : Type*) (R : out_param $ Type*) [semi_normed_comm_ring R]
  (S : out_param $ Type*) [ring S] [algebra R S]
  extends seminorm_class F R S, mul_ring_norm_class F S ℝ
